...
#define MAVLINK_MSG_ID_motor_io_CRC 154
#define MAVLINK_MSG_ID_4_CRC 154
...
#define MAVLINK_MESSAGE_INFO_motor_io { \
    ...
    {  { "motor_dir", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_motor_io_t, motor_dir) }, \
         ...
         { "mtest", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_motor_io_t, mtest) }, \
...
static inline uint16_t mavlink_msg_motor_io_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t motor_dir, uint8_t motor_min, uint8_t motor_dshot, uint8_t mtest, uint8_t motor4)
{
...
{
    return mavlink_msg_motor_io_pack(system_id, component_id, msg, motor_io->motor_dir, motor_io->motor_min, motor_io->motor_dshot, motor_io->mtest, motor_io->motor4);
}
...
{
    return mavlink_msg_motor_io_pack_chan(system_id, component_id, chan, msg, motor_io->motor_dir, motor_io->motor_min, motor_io->motor_dshot, motor_io->mtest, motor_io->motor4);
}
...
static inline void mavlink_msg_motor_io_send(mavlink_channel_t chan, uint8_t motor_dir, uint8_t motor_min, uint8_t motor_dshot, uint8_t mtest, uint8_t motor4)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_motor_io_LEN];
    _mav_put_uint8_t(buf, 0, motor_dir);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_motor_io_send(chan, motor_io->motor_dir, motor_io->motor_min, motor_io->motor_dshot, motor_io->mtest, motor_io->motor4);
#else
 ...
 */
static inline void mavlink_msg_motor_io_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t motor_dir, uint8_t motor_min, uint8_t motor_dshot, uint8_t mtest, uint8_t motor4)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field mtest from motor_io message
 *
 * @return  motor test
 */
static inline uint8_t mavlink_msg_motor_io_get_mtest(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_motor_io_decode(const mavlink_message_t* msg, mavlink_motor_io_t* motor_io)
{
    ...
    motor_io->mtest = mavlink_msg_motor_io_get_mtest(msg);
