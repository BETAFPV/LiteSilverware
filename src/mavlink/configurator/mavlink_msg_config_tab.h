...
#define MAVLINK_MSG_ID_config_tab_LEN 1
#define MAVLINK_MSG_ID_config_tab_MIN_LEN 1
#define MAVLINK_MSG_ID_9_LEN 1
#define MAVLINK_MSG_ID_9_MIN_LEN 1

#define MAVLINK_MSG_ID_config_tab_CRC 12
#define MAVLINK_MSG_ID_9_CRC 12
...
{
    return mavlink_msg_config_tab_pack(system_id, component_id, msg, config_tab->tab_index);
}
...
{
    return mavlink_msg_config_tab_pack_chan(system_id, component_id, chan, msg, config_tab->tab_index);
}
...
static inline void mavlink_msg_config_tab_send(mavlink_channel_t chan, uint8_t tab_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_config_tab_LEN];
    _mav_put_uint8_t(buf, 0, tab_index);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_config_tab_send(chan, config_tab->tab_index);
#else
 ...
 */
static inline void mavlink_msg_config_tab_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t tab_index)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
