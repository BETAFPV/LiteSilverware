...
#define LVC_LOWER_THROTTLE_VOLTAGE 6.6
#define LVC_LOWER_THROTTLE_VOLTAGE_RAW 5.4
#define LVC_LOWER_THROTTLE_KP 6.0
...
#define ACTUAL_BATTERY_VOLTAGE 8.40
#define REPORTED_TELEMETRY_VOLTAGE 8.40
...
#define BATTERYPORT GPIOA
#define BATTERY_ADC_CHANNEL ADC_Channel_5
#define ADC_SCALEFACTOR 0.0020500
#define ADC_REF 1.0f
