...
#define RGB_VALUE_INFLIGHT_ON RGB( 0 , 255 , 255 )

// normal flight rgb colour - LED switch OFF
#define RGB_VALUE_INFLIGHT_OFF RGB( 0 , 0 , 0 )

//  colour before bind
#define RGB_VALUE_BEFORE_BIND RGB( 0 , 0 , 255 )
...
// led flash logic
        if (lowbatt)
        {
            ...
            rgb_ledflash(RGB(0 , 255 , 0), RGB(0 , 0 , 0) , 500000 , 8);
        }
        else
        {
            ...
            else
            {
                ...
                {
                    // failsafe flash
                    rgb_ledflash(RGB(255 , 0 , 0) , RGB(0 , 0 , 255) , 500000, 8);
